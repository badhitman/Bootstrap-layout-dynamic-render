...
{
    public class bsPagination : ahsDom
    {
        ...
        public hmAlignmentEnum AlignmentPagination = hmAlignmentEnum.right;

        public bmSizingsEnum? SiziePagination = null;
        ...
        public override string ViewComponentName => nameof(brPagination);
        ...
        public bsPagination Init(int data_list_count, string url_tmpl, int _PageNum, int _PageSize)
        {
